...
public final class ActivityThread {
    ...
    /**
     * Type for IActivityManager.serviceDoneExecuting: done with an onStart
     * call
     */
    ...
    // manager or window manager or anything that depends on them while holding
    // this lock. These LoadedApk are only valid for the userId that we're
    // running as.
    ...
    static final class ActivityClientRecord {
        ...
        public String toString() {
            ...
            return "ActivityRecord{" + Integer.toHexString(System.identityHashCode(this)) +
                " token=" + token + " " +
    ...
    static final class ReceiverData extends BroadcastReceiver.PendingResult {
        ...
        CompatibilityInfo compatInfo;
        public String toString() {
            return "ReceiverData{intent=" + intent + " packageName=" + info.packageName +
                " resultCode=" + getResultCode() + " resultData=" + getResultData() +
                " resultExtras=" + getResultExtras(false) + "}";
        }
    }
    ...
    static final class CreateBackupAgentData {
        ...
        public String toString() {
            return "CreateBackupAgentData{appInfo=" + appInfo +
                " backupAgent=" + appInfo.backupAgentName + " mode=" + backupMode + "}";
        }
    }
    ...
    static final class CreateServiceData {
        ...
        Intent intent;
        public String toString() {
            return "CreateServiceData{token=" + token + " className=" + info.name +
                " packageName=" + info.packageName + " intent=" + intent + "}";
        }
    }
    ...
    public static ClassLoader getClassloader() {
        ...
        // mBoundApplication is `android.app.ActivityThread$AppBindData`
        Object mBoundApplication = getFieldOjbect("android.app.ActivityThread",
                                                  currentActivityThread, "mBoundApplication");

        // http://androidxref.com/6.0.1_r10/xref/frameworks/base/core/java/android/app/LoadedApk.java
        // loadedApkInfo is `android.app.LoadedApk`
        Object loadedApkInfo =
            getFieldOjbect("android.app.ActivityThread$AppBindData", mBoundApplication, "info");

        // http://androidxref.com/6.0.1_r10/xref/frameworks/base/core/java/android/app/Application.java
        Application mApplication =
            (Application)getFieldOjbect("android.app.LoadedApk", loadedApkInfo, "mApplication");
    ...
    public static void loadClassAndInvoke(ClassLoader appClassloader, String eachclassname,
        ...
        Log.i("ActivityThread", "go into loadClassAndInvoke->"
    ...
    /*
     * Here, we get the real `ClassLoader` of `Application` to get `DexFile`s.
     * Then, dumping all methods of class of `DexFile`.
     */
    public static void fart() {
        // This ClassLoader is `dalvik.system.BaseDexClassLoader`
        ...
        Field pathList_Field =
            (Field)getClassField(appClassloader, "dalvik.system.BaseDexClassLoader", "pathList");
        Object pathList_object =
            getFieldOjbect("dalvik.system.BaseDexClassLoader", appClassloader, "pathList");

        // http://androidxref.com/6.0.1_r10/xref/libcore/dalvik/src/main/java/dalvik/system/DexPathList.java
        Object[] ElementsArray =
            (Object[])getFieldOjbect("dalvik.system.DexPathList", pathList_object, "dexElements");
        Field dexFile_fileField = null;
        try {
            // dalvik.system.DexFile:
            // http://androidxref.com/6.0.1_r10/xref/libcore/dalvik/src/main/java/dalvik/system/DexFile.java
            // Element.dexFile is DexFile
            dexFile_fileField = (Field)getClassField(
                appClassloader, "dalvik.system.DexPathList$Element", "dexFile");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        // Died code
        // Use `getClassFieldObject` instead.
        // {{{
        ...
        for (int j = 0; j < ElementsArray.length; j++) {
            ...
            if (dexfile != null) {
                ...
                Object mcookie = getClassFieldObject(appClassloader, "dalvik.system.DexFile",
                                                     dexfile, "mCookie");
                if (mcookie == null) {
                    continue;
                }
                ...
                try {
                    // http://androidxref.com/6.0.1_r10/xref/libcore/dalvik/src/main/java/dalvik/system/DexFile.java#303
        ...
        public void startProfiling() {
            ...
            try {
                VMDebug.startMethodTracing(profileFile, profileFd.getFileDescriptor(),
                                           8 * 1024 * 1024, 0, samplingInterval != 0,
                                           samplingInterval);
                profiling = true;
    ...
    private class ApplicationThread extends ApplicationThreadNative {
        ...
        public final void scheduleStopActivity(IBinder token, boolean showWindow,
                                               int configChanges) {
            sendMessage(showWindow ? H.STOP_ACTIVITY_SHOW : H.STOP_ACTIVITY_HIDE, token, 0,
                        configChanges);
        }
        ...
        @Override
        public final void
        scheduleLaunchActivity(Intent intent, IBinder token, int ident, ActivityInfo info,
        ...
        public final void scheduleRelaunchActivity(IBinder token, List<ResultInfo> pendingResults,
                                                   ...
                                                   Configuration config,
                                                   Configuration overrideConfig) {
            requestRelaunchActivity(token, pendingResults, pendingNewIntents, configChanges,
                                    notResumed, config, overrideConfig, true);
        }
        ...
        public final void scheduleReceiver(Intent intent, ActivityInfo info,
                                           CompatibilityInfo compatInfo, int resultCode,
                                           String data, Bundle extras, boolean sync,
                                           int sendingUser, int processState) {
            updateProcessState(processState, false);
            ReceiverData r = new ReceiverData(intent, resultCode, data, extras, sync, false,
                                              mAppThread.asBinder(), sendingUser);
            r.info = info;
            r.compatInfo = compatInfo;
        ...
        public final void
        bindApplication(String processName, ApplicationInfo appInfo, List<ProviderInfo> providers,
                        ComponentName instrumentationName, ProfilerInfo profilerInfo,
                        Bundle instrumentationArgs, IInstrumentationWatcher instrumentationWatcher,
                        IUiAutomationConnection instrumentationUiConnection, int debugMode,
                        boolean enableOpenGlTrace, boolean isRestrictedBackupMode,
        ...
        public final void scheduleSuicide() { sendMessage(H.SUICIDE, null); }
        ...
        public void updateTimeZone() { TimeZone.setDefault(null); }

        public void clearDnsCache() {
            // a non-standard API to get this to libcore
            InetAddress.clearDnsCache();
            // Allow libcore to perform the necessary actions as it sees fit
            // upon a network configuration change.
        ...
        // driver applies transaction ordering per object for such calls.
        ...
        public void dumpActivity(FileDescriptor fd, IBinder activitytoken, String prefix,
                                 String[] args) {
            DumpComponentInfo data = new DumpComponentInfo();
            try {
                data.fd = ParcelFileDescriptor.dup(fd);
        ...
        private void dumpMemInfo(PrintWriter pw, Debug.MemoryInfo memInfo, boolean checkin,
            ...
            dumpMemInfoTable(
                pw, memInfo, checkin, dumpFullInfo, dumpDalvik, dumpSummaryOnly, Process.myPid(),
                (mBoundApplication != null) ? mBoundApplication.processName : "unknown", nativeMax,
                nativeAllocated, nativeFree, dalvikMax, dalvikAllocated, dalvikFree);

            if (checkin) {
                // NOTE: if you change anything significant below, also consider
                // changing ACTIVITY_THREAD_CHECKIN_VERSION.
            ...
            printRow(pw, TWO_COUNT_COLUMNS, "Views:", viewInstanceCount,
                     "ViewRootImpl:", viewRootInstanceCount);
            ...
            printRow(pw, TWO_COUNT_COLUMNS, "PAGECACHE_OVERFLOW:", stats.pageCacheOverflow / 1024,
                     "MALLOC_SIZE:", stats.largestMemAlloc / 1024);
            pw.println(" ");
        ...
        public void scheduleTrimMemory(int level) { sendMessage(H.TRIM_MEMORY, null, level); }
        ...
        public void updateProcessState(int processState, boolean fromIpc) {
            synchronized (this) {
                if (mLastProcessState != processState) {
                    ...
                    // Update Dalvik state based on
                    // ActivityManager.PROCESS_STATE_* constants.
                    final int DALVIK_PROCESS_STATE_JANK_PERCEPTIBLE = 0;
                    final int DALVIK_PROCESS_STATE_JANK_IMPERCEPTIBLE = 1;
                    int dalvikProcessState = DALVIK_PROCESS_STATE_JANK_IMPERCEPTIBLE;
                    // TODO: Tune this since things like gmail sync are
                    // important background but not jank perceptible.
                    ...
                    if (false) {
                        Slog.i(TAG, "******************* PROCESS STATE CHANGED TO: " +
    ...
    private class H extends Handler {
        ...
        private void maybeSnapshot() {
            if (mBoundApplication != null && SamplingProfilerIntegration.isEnabled()) {
                ...
                // known android.content.pm.PackageInfo
    ...
    public static String currentOpPackageName() {
        ...
        return (am != null && am.getApplication() != null) ? am.getApplication().getOpPackageName()
                                                           : null;
    }
    ...
    public final LoadedApk getPackageInfo(String packageName, CompatibilityInfo compatInfo,
        ...
        synchronized (mResourcesManager) {
            ...
            // packageInfo); if (packageInfo != null) Slog.i(TAG, "isUptoDate "
            // + packageInfo.mResDir
            ...
            if (packageInfo != null && (packageInfo.mResources == null ||
                ...
                if (packageInfo.isSecurityViolation() &&
                    ...
                    throw new SecurityException(
                        "Requesting code from " + packageName + " to be run in process " +
        ...
        try {
            ai = getPackageManager().getApplicationInfo(
                packageName, PackageManager.GET_SHARED_LIBRARY_FILES, userId);
        } catch (RemoteException e) {
            // Ignore
        }
    ...
    public final LoadedApk getPackageInfo(ApplicationInfo ai, CompatibilityInfo compatInfo,
        ...
        boolean securityViolation =
            includeCode && ai.uid != 0 && ai.uid != Process.SYSTEM_UID &&
        ...
        if ((flags & (Context.CONTEXT_INCLUDE_CODE | Context.CONTEXT_IGNORE_SECURITY)) ==
            ...
            if (securityViolation) {
                String msg =
                    "Requesting code from " + ai.packageName + " (with uid " + ai.uid + ")";
                if (mBoundApplication != null) {
                    msg = msg + " to be run in process " + mBoundApplication.processName +
                          " (with uid " + mBoundApplication.appInfo.uid + ")";
                }
                ...
                if (localLOGV)
                    Slog.v(
                        ...
                        (includeCode ? "Loading code package " : "Loading resource-only package ") +
                            ...
                            ")");
                packageInfo =
                    new LoadedApk(this, aInfo, compatInfo, baseLoader, securityViolation,
                                  includeCode && (aInfo.flags & ApplicationInfo.FLAG_HAS_CODE) != 0,
                                  registerPackage);

                if (mSystemThread && "android".equals(aInfo.packageName)) {
                    packageInfo.installSystemApplicationInfo(
                        aInfo, getSystemContext().mPackageInfo.getClassLoader());
                }
    ...
    public String getProfileFilePath() { return mProfiler.profileFile; }

    public Looper getLooper() { return mLooper; }

    public Application getApplication() { return mInitialApplication; }

    public String getProcessName() { return mBoundApplication.processName; }
    ...
    public static void dumpMemInfoTable(PrintWriter pw, Debug.MemoryInfo memInfo, boolean checkin,
                                        boolean dumpFullInfo, boolean dumpDalvik,
                                        boolean dumpSummaryOnly, int pid, String processName,
        ...
        if (!dumpSummaryOnly) {
            if (dumpFullInfo) {
                printRow(pw, HEAP_FULL_COLUMN, "", "Pss", "Pss", "Shared", "Private", "Shared",
                         "Private", "Swapped", "Heap", "Heap", "Heap");
                printRow(pw, HEAP_FULL_COLUMN, "", "Total", "Clean", "Dirty", "Dirty", "Clean",
                ...
                printRow(pw, HEAP_FULL_COLUMN, "Native Heap", memInfo.nativePss,
                         ...
                         memInfo.nativePrivateClean, memInfo.nativeSwappedOut, nativeMax,
                         nativeAllocated, nativeFree);
                printRow(pw, HEAP_FULL_COLUMN, "Dalvik Heap", memInfo.dalvikPss,
                         memInfo.dalvikSwappablePss, memInfo.dalvikSharedDirty,
                         memInfo.dalvikPrivateDirty, memInfo.dalvikSharedClean,
                         memInfo.dalvikPrivateClean, memInfo.dalvikSwappedOut, dalvikMax,
                         dalvikAllocated, dalvikFree);
            } else {
                printRow(pw, HEAP_COLUMN, "", "Pss", "Private", "Private", "Swapped", "Heap",
                         "Heap", "Heap");
                printRow(pw, HEAP_COLUMN, "", "Total", "Dirty", "Clean", "Dirty", "Size", "Alloc",
                         "Free");
                printRow(pw, HEAP_COLUMN, "", "------", "------", "------", "------", "------",
                         "------", "------", "------");
                printRow(pw, HEAP_COLUMN, "Native Heap", memInfo.nativePss,
                         memInfo.nativePrivateDirty, memInfo.nativePrivateClean,
                         memInfo.nativeSwappedOut, nativeMax, nativeAllocated, nativeFree);
                printRow(pw, HEAP_COLUMN, "Dalvik Heap", memInfo.dalvikPss,
                         memInfo.dalvikPrivateDirty, memInfo.dalvikPrivateClean,
                         memInfo.dalvikSwappedOut, dalvikMax, dalvikAllocated, dalvikFree);
            }
            ...
            for (int i = 0; i < Debug.MemoryInfo.NUM_OTHER_STATS; i++) {
                ...
                if (myPss != 0 || mySharedDirty != 0 || myPrivateDirty != 0 || mySharedClean != 0 ||
                    myPrivateClean != 0 || mySwappedOut != 0) {
                    if (dumpFullInfo) {
                        printRow(pw, HEAP_FULL_COLUMN, Debug.MemoryInfo.getOtherLabel(i), myPss,
                                 mySwappablePss, mySharedDirty, myPrivateDirty, mySharedClean,
                                 myPrivateClean, mySwappedOut, "", "", "");
                    } else {
                        printRow(pw, HEAP_COLUMN, Debug.MemoryInfo.getOtherLabel(i), myPss,
                                 myPrivateDirty, myPrivateClean, mySwappedOut, "", "", "");
                    }
                    otherPss -= myPss;
            ...
            if (dumpFullInfo) {
                ...
                printRow(pw, HEAP_FULL_COLUMN, "TOTAL", memInfo.getTotalPss(),
                         memInfo.getTotalSwappablePss(), memInfo.getTotalSharedDirty(),
                         memInfo.getTotalPrivateDirty(), memInfo.getTotalSharedClean(),
                         memInfo.getTotalPrivateClean(), memInfo.getTotalSwappedOut(),
                ...
                printRow(pw, HEAP_COLUMN, "TOTAL", memInfo.getTotalPss(),
                         memInfo.getTotalPrivateDirty(), memInfo.getTotalPrivateClean(),
        ...
        pw.println(" ");
        printRow(pw, TWO_COUNT_COLUMNS, "TOTAL:", memInfo.getSummaryTotalPss(),
    ...
    public final Activity startActivityNow(
        Activity parent, String id, Intent intent, ActivityInfo activityInfo, IBinder token,
        Bundle state, Activity.NonConfigurationInstances lastNonConfigurationInstances) {
        ActivityClientRecord r = new ActivityClientRecord();
        r.token = token;
        r.ident = 0;
        r.intent = intent;
        ...
        if (localLOGV) {
            ...
            Slog.v(TAG, "Performing launch: action=" + intent.getAction() + ", comp=" + name +
                            ", token=" + token);
        }
    ...
    public final void sendActivityResult(IBinder token, String id, int requestCode, int resultCode,
                                         Intent data) {
        if (DEBUG_RESULTS)
            Slog.v(TAG, "sendActivityResult: id=" + id + " req=" + requestCode +
    ...
    private Activity performLaunchActivity(ActivityClientRecord r, Intent customIntent) {
        ...
        if (r.packageInfo == null) {
            r.packageInfo =
                getPackageInfo(aInfo.applicationInfo, r.compatInfo, Context.CONTEXT_INCLUDE_CODE);
        }
        ...
        if (r.activityInfo.targetActivity != null) {
            component =
                new ComponentName(r.activityInfo.packageName, r.activityInfo.targetActivity);
        }
        ...
        try {
            ...
            if (localLOGV)
                Slog.v(TAG, r + ": app=" + app + ", appName=" + app.getPackageName() +
            ...
            if (activity != null) {
                ...
                if (DEBUG_CONFIGURATION)
                    Slog.v(TAG,
                           "Launching activity " + r.activityInfo.name + " with config " + config);
    ...
    private Context createBaseContextForActivity(ActivityClientRecord r, final Activity activity) {
        ...
        ContextImpl appContext =
            ContextImpl.createActivityContext(this, r.packageInfo, displayId, r.overrideConfig);
        appContext.setOuterContext(activity);
        Context baseContext = appContext;

        final DisplayManagerGlobal dm = DisplayManagerGlobal.getInstance();
        // For debugging purposes, if the activity's package name contains the
        // value of the "debug.use-second-display" system property as a
        // substring, then show its content on a secondary display if there is
        // one.
    ...
    private void handleLaunchActivity(ActivityClientRecord r, Intent customIntent) {
        ...
        if (a != null) {
            ...
            // manager to stop us.
            try {
                ActivityManagerNative.getDefault().finishActivity(r.token, Activity.RESULT_CANCELED,
                                                                  null, false);
            } catch (RemoteException ex) {
                // Ignore
            }
        ...
        if (r != null) {
            ...
            if (cmd.requestType == ActivityManager.ASSIST_CONTEXT_FULL) {
                ...
                if (activityIntent != null &&
                    (r.window == null || (r.window.getAttributes().flags &
    ...
    public void handleCancelVisibleBehind(IBinder token) {
        ...
        if (r != null) {
            ...
            if (activity.mVisibleBehind) {
                ...
                // Tick, tick, tick. The activity has 500 msec to return or it
                // will be destroyed.
                if (!activity.mCalled) {
                    throw new SuperNotCalledException(
     ...
     * @hide
     */
    public static Intent getIntentBeingBroadcast() { return sCurrentBroadcastIntent.get(); }
    ...
    private void handleReceiver(ReceiverData data) {
        ...
        try {
            ...
            throw new RuntimeException(
                "Unable to instantiate receiver " + component + ": " + e.toString(), e);
        }
        ...
        try {
            ...
            if (localLOGV)
                Slog.v(TAG, "Performing receive of " + data.intent + ": app=" + app + ", appName=" +
                                app.getPackageName() + ", pkg=" + packageInfo.getPackageName() +
            ...
            if (!mInstrumentation.onException(receiver, e)) {
                throw new RuntimeException(
                    "Unable to start receiver " + component + ": " + e.toString(), e);
            }
        } finally {
    ...
    private void handleCreateBackupAgent(CreateBackupAgentData data) {
        ...
        try {
            ...
            if (requestedPackage.applicationInfo.uid != Process.myUid()) {
                Slog.w(TAG,
                       "Asked to instantiate non-matching package " + data.appInfo.packageName);
                return;
            }
        } catch (RemoteException e) {
        ...
        try {
            ...
            throw new RuntimeException(
                "Unable to create BackupAgent " + classname + ": " + e.toString(), e);
        }
    }
            ...
            try {
                ...
                try {
                    if (!data.rebind) {
                        ...
                        ActivityManagerNative.getDefault().publishService(data.token, data.intent,
                                                                          binder);
                    } else {
                ...
                if (!mInstrumentation.onException(s, e)) {
                    throw new RuntimeException("Unable to bind to service " + s + " with " +
                                                   data.intent + ": " + e.toString(),
                                               e);
                }
            }
        }
    ...
    private void handleUnbindService(BindServiceData data) {
        ...
        if (s != null) {
            try {
                ...
                try {
                    if (doRebind) {
                        ActivityManagerNative.getDefault().unbindFinished(data.token, data.intent,
                                                                          doRebind);
                    } else {
                        ActivityManagerNative.getDefault().serviceDoneExecuting(
                            data.token, SERVICE_DONE_EXECUTING_ANON, 0, 0);
                ...
                if (!mInstrumentation.onException(s, e)) {
                    throw new RuntimeException("Unable to unbind to service " + s + " with " +
                                                   data.intent + ": " + e.toString(),
                                               e);
                }
            }
    ...
    private void handleDumpService(DumpComponentInfo info) {
        ...
        try {
            ...
            if (s != null) {
                PrintWriter pw =
                    new FastPrintWriter(new FileOutputStream(info.fd.getFileDescriptor()));
        ...
        if (s != null) {
            try {
                ...
                try {
                    ...
                    // nothing to do.
                    Slog.i(TAG,
                           "handleStopService: unable to execute serviceDoneExecuting for " + token,
                           e);
                }
            } catch (Exception e) {
                if (!mInstrumentation.onException(s, e)) {
                    throw new RuntimeException("Unable to stop service " + s + ": " + e.toString(),
                                               e);
                }
    ...
    static final void cleanUpPendingRemoveWindows(ActivityClientRecord r) {
        if (r.mPendingRemoveWindow != null) {
            ...
            if (wtoken != null) {
                WindowManagerGlobal.getInstance().closeAll(wtoken, r.activity.getClass().getName(),
                                                           "Activity");
            }
        }
    ...
    final void handleResumeActivity(IBinder token, boolean clearHide, boolean isForward,
        ...
        if (r != null) {
            ...
            final int forwardBit =
                isForward ? WindowManager.LayoutParams.SOFT_INPUT_IS_FORWARD_NAVIGATION : 0;
            ...
            try {
                ActivityManagerNative.getDefault().finishActivity(token, Activity.RESULT_CANCELED,
                                                                  null, false);
            } catch (RemoteException ex) {
            }
        }
    ...
    private Bitmap createThumbnailBitmap(ActivityClientRecord r) {
        ...
        try {
            ...
            if (!mInstrumentation.onException(r.activity, e)) {
                throw new RuntimeException("Unable to create thumbnail of " +
                                               r.intent.getComponent().toShortString() + ": " +
                                               e.toString(),
                                           e);
            }
    ...
    final Bundle performPauseActivity(ActivityClientRecord r, boolean finished, boolean saveState) {
        if (r.paused) {
            if (r.activity.mFinished) {
                ...
                // cases. So here we likewise don't want to call onPause() if
                // the activity isn't resumed.
                return null;
            }
            RuntimeException e =
                new RuntimeException("Performing pause of activity that is not resumed: " +
                                     r.intent.getComponent().toShortString());
        ...
        synchronized (mOnPauseListeners) { listeners = mOnPauseListeners.remove(r.activity); }
    ...
    private static class StopInfo implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                ActivityManagerNative.getDefault().activityStopped(activity.token, state,
                                                                   persistentState, description);
            } catch (RemoteException ex) {
            }
        }
    }
    ...
    private void performStopActivityInner(ActivityClientRecord r, StopInfo info, boolean keepShown,
        ...
        if (r != null) {
            if (!keepShown && r.stopped) {
                ...
                RuntimeException e =
                    new RuntimeException("Performing stop of activity that is not resumed: " +
                                         r.intent.getComponent().toShortString());
                Slog.e(TAG, e.getMessage(), e);
            }
            ...
            if (!keepShown) {
                try {
                    ...
                    if (!mInstrumentation.onException(r.activity, e)) {
                        throw new RuntimeException("Unable to stop activity " +
                                                       r.intent.getComponent().toShortString() +
                                                       ": " + e.toString(),
                                                   e);
                    }
        ...
        if (v != null) {
            if (show) {
                ...
                if (r.newConfig != null) {
                    ...
                    if (DEBUG_CONFIGURATION)
                        Slog.v(TAG, "Updating activity vis " + r.activityInfo.name +
                                        " with new config " + r.tmpConfig);
                    performConfigurationChanged(r.activity, r.tmpConfig);
                    freeTextLayoutCachesIfNeeded(r.activity.mCurrentConfig.diff(r.tmpConfig));
                    r.newConfig = null;
                }
    ...
    private void handleSetCoreSettings(Bundle coreSettings) {
        synchronized (mResourcesManager) { mCoreSettings = coreSettings; }
    ...
    private void handleDestroyActivity(IBinder token, boolean finishing, int configChanges,
        ...
        if (r != null) {
            ...
            if (v != null) {
                ...
                if (wtoken != null && r.mPendingRemoveWindow == null) {
                    WindowManagerGlobal.getInstance().closeAll(
                        wtoken, r.activity.getClass().getName(), "Activity");
                }
            ...
            if (r.mPendingRemoveWindow == null) {
                ...
                // leaks.
                WindowManagerGlobal.getInstance().closeAll(token, r.activity.getClass().getName(),
                                                           "Activity");
            }
    ...
    ArrayList<ComponentCallbacks2> collectComponentCallbacks(boolean allActivities,
                                                             Configuration newConfig) {
            ...
            for (int i = 0; i < NACT; i++) {
                ...
                if (a != null) {
                    Configuration thisConfig = applyConfigCompatMainThread(
                        mCurDefaultDisplayDpi, newConfig, ar.packageInfo.getCompatibilityInfo());
                    if (!ar.activity.mFinished && (allActivities || !ar.paused)) {
                        // If the activity is currently resumed, its
                        // configuration needs to change right now.
                        callbacks.add(a);
                        ...
                        // configuration.
                        if (DEBUG_CONFIGURATION) {
                            Slog.v(TAG, "Setting activity " + ar.activityInfo.name +
    ...
    private void updateDefaultDensity() {
        if (mCurDefaultDisplayDpi != Configuration.DENSITY_DPI_UNDEFINED &&
            mCurDefaultDisplayDpi != DisplayMetrics.DENSITY_DEVICE && !mDensityCompatMode) {
            Slog.i(TAG, "Switching default density from " + DisplayMetrics.DENSITY_DEVICE + " to " +
    ...
    private void handleBindApplication(AppBindData data) {
        ...
        if (!Process.isIsolated()) {
            ...
            if (cacheDir != null) {
                ...
                Log.v(
                    TAG,
                    "Unable to initialize \"java.io.tmpdir\" property due to missing cache directory");
            }
        ...
        if (b != null) {
            ...
            // don't crash if we can't get it.
        ...
        if (data.instrumentationName != null) {
            ...
            try {
                ii = appContext.getPackageManager().getInstrumentationInfo(data.instrumentationName,
                                                                           0);
            } catch (PackageManager.NameNotFoundException e) {
            }
            if (ii == null) {
                throw new RuntimeException("Unable to find instrumentation info for: " +
            ...
            LoadedApk pi = getPackageInfo(instrApp, data.compatInfo, appContext.getClassLoader(),
                                          false, true, false);
            ...
            try {
                ...
                mInstrumentation =
                    (Instrumentation)cl.loadClass(data.instrumentationName.getClassName())
                        .newInstance();
            } catch (Exception e) {
            ...
            mInstrumentation.init(
                this, instrContext, appContext, new ComponentName(ii.packageName, ii.name),
        ...
        if ((data.appInfo.flags & ApplicationInfo.FLAG_LARGE_HEAP) != 0) {
            ...
            // Small heap, clamp to the current growth limit and let the heap
            // release pages after the growth limit to the non growth limit
            // capacity. b/18387825
        ...
        try {
            ...
            // the app's custom Application class
            ...
            // start their test thread at this point, and we don't want that
            // racing.
            try {
            ...
            try {
                ...
                if (!mInstrumentation.onException(app, e)) {
                    throw new RuntimeException("Unable to create application " +
                                                   app.getClass().getName() + ": " + e.toString(),
                                               e);
                }
            }
        } finally {
    ...
    private void installContentProviders(Context context, List<ProviderInfo> providers) {
        ...
        for (ProviderInfo cpi : providers) {
            ...
            IActivityManager.ContentProviderHolder cph = installProvider(
                context, null, cpi, false /*noisy*/, true /*noReleaseNeeded*/, true /*stable*/);
            if (cph != null) {
    ...
    public final IContentProvider acquireProvider(Context c, String auth, int userId,
        ...
        // ensure that the first one wins. Note that we cannot hold the lock
        // while acquiring and installing the provider since it might take a
        // long time to run and it could also potentially be re-entrant in the
        // case where the provider is in the same process.
        IActivityManager.ContentProviderHolder holder = null;
        try {
            holder = ActivityManagerNative.getDefault().getContentProvider(getApplicationThread(),
                                                                           auth, userId, stable);
        } catch (RemoteException ex) {
        }
        if (holder == null) {
        ...
        holder =
            installProvider(c, holder, holder.info, true /*noisy*/, holder.noReleaseNeeded, stable);
    ...
    private final void incProviderRefLocked(ProviderRefCount prc, boolean stable) {
        if (stable) {
            ...
            if (prc.stableCount == 1) {
                ...
                try {
                    if (DEBUG_PROVIDER) {
                        Slog.v(TAG, "incProviderRef Now stable - " + prc.holder.info.name +
                                        ": unstableDelta=" + unstableDelta);
                    }
            ...
            if (prc.unstableCount == 1) {
                ...
                if (prc.removePending) {
                    ...
                    try {
                        ...
                        ActivityManagerNative.getDefault().refContentProvider(prc.holder.connection,
                                                                              0, 1);
                    } catch (RemoteException e) {
                        // do nothing content provider object is dead any way
                    }
    ...
    public final IContentProvider acquireExistingProvider(Context c, String auth, int userId,
                                                          boolean stable) {
        synchronized (mProviderMap) {
            ...
            // the provider is not reference counted and never needs to be
            // released.
        ...
        synchronized (mProviderMap) {
            ...
            if (lastRef) {
                if (!prc.removePending) {
                    ...
                    // know the context this will be called in.
    ...
    final void handleUnstableProviderDied(IBinder provider, boolean fromClient) {
        synchronized (mProviderMap) { handleUnstableProviderDiedLocked(provider, fromClient); }
    }
    ...
    final void appNotRespondingViaProvider(IBinder provider) {
        synchronized (mProviderMap) {
            ...
            if (prc != null) {
                try {
                    ActivityManagerNative.getDefault().appNotRespondingViaProvider(
    ...
    installProviderAuthoritiesLocked(IContentProvider provider, ContentProvider localProvider,
                                     IActivityManager.ContentProviderHolder holder) {
        final String auths[] = holder.info.authority.split(";");
        final int userId = UserHandle.getUserId(holder.info.applicationInfo.uid);

        final ProviderClientRecord pcr =
            new ProviderClientRecord(auths, provider, localProvider, holder);
        for (String auth : auths) {
            final ProviderKey key = new ProviderKey(auth, userId);
            final ProviderClientRecord existing = mProviderMap.get(key);
            if (existing != null) {
                Slog.w(TAG, "Content provider " + pcr.mHolder.info.name + " already published as " +
                                auth);
            } else {
     ...
     * this happens, it increments the reference count of the existing provider
     * (if appropriate) and returns the existing provider.  This can happen due
     * to concurrent attempts to acquire the same provider.
     */
    private IActivityManager.ContentProviderHolder
    installProvider(Context context, IActivityManager.ContentProviderHolder holder,
        ...
        if (holder == null || holder.provider == null) {
            ...
            if (c == null) {
                Slog.w(TAG, "Unable to get context for package " + ai.packageName +
                                " while loading content provider " + info.name);
                return null;
            }
            try {
            ...
            if (localProvider != null) {
                ...
                if (prc != null) {
                    ...
                    ProviderClientRecord client =
                        installProviderAuthoritiesLocked(provider, localProvider, holder);
                    if (noReleaseNeeded) {
    ...
    private void attach(boolean system) {
        ...
        if (!system) {
            ...
            try {
                ...
                throw new RuntimeException("Unable to instantiate Application():" + e.toString(),
                                           e);
            }
        }
    ...
    private class DropBoxReporter implements DropBox.Reporter {
        ...
        private synchronized void ensureInitialized() {
            if (dropBox == null) {
                dropBox =
                    (DropBoxManager)getSystemContext().getSystemService(Context.DROPBOX_SERVICE);
            }
        }
    }
