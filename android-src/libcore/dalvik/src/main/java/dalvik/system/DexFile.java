...
public final class DexFile {
    ...
    private DexFile(String sourceName, String outputName, int flags) throws IOException {
            ...
            try {
                ...
                if (Libcore.os.getuid() != Libcore.os.stat(parent).st_uid) {
                    throw new IllegalArgumentException(
                        "Optimized data directory " + parent +
        ...
        guard.open("close");
        // System.out.println("DEX FILE cookie is " + mCookie + " sourceName=" + sourceName + "
     ...
     */
    public Enumeration<String> entries() { return new DFEnum(this); }
    ...
    private class DFEnum implements Enumeration<String> {
        ...
        public boolean hasMoreElements() { return (mIndex < mNameList.length); }

        public String nextElement() { return mNameList[mIndex++]; }
    }
    ...
    private static Object openDexFile(String sourceName, String outputName, int flags)
        ...
        return openDexFileNative(
            new File(sourceName).getAbsolutePath(),
            (outputName == null) ? null : new File(outputName).getAbsolutePath(), flags);
    }
     ...
     * @hide
     */
    public static native int getDexOptNeeded(String fileName, String pkgname, String instructionSet,
                                             boolean defer)
        throws FileNotFoundException, IOException;
}
